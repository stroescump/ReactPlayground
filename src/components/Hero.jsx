    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto text-center relative w-full">
                <div className="max-w-7-xl mx-auto flex flex-col lg:grid lg:grid-cols-2 text-center lg:text-left gap-6 sm:gap-8 lg:gap-12 items-center relative">
                    <div>
                        ...
                        <p className="text-md sm:text-base lg:text-lg text-gray-400 max-w-2xl mx-auto lg:mx-0 sm:mb-8 mb-6 animate-in slide-in-from-bottom duration-700 delay-200 leading-relaxed">
                    ...
                    <div className="relative order-2 w-full">
                        <div className="relative bg-white/5 backdrop:blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
                                    ...
                                    <div className="flex space-x-1 sm:space-x-2 mb-3 sm:mb-4 overflow-x-auto">
                                        <button
                                            ...
                                            className={`px-3 py-2 backdrop-blur-sm text-xs sm:text-sm rounded-t-lg border ${activeTab === "App.jsx"
                                                ...
                                                : "bg-white/5 text-gray-300 border-white/10 hover:bg-white/5"} text-gray-300 transition-all duration-200 whitespace-nowrap`}>App.jsx</button>
                                        <button
                                            ...
                                            className={`px-3 py-2 backdrop-blur-sm text-xs sm:text-sm rounded-t-lg border ${activeTab === "Hero.jsx"
                                                ? "bg-blue-500/30 text-white border-blue-400/20"
                                                : "bg-white/5 text-gray-300 border-white/10 hover:bg-white/5"} text-gray-300 transition-all duration-200 whitespace-nowrap`}>Hero.jsx</button>
                                        <button
                                            ...
                                            className={`px-3 py-2 backdrop-blur-sm text-xs sm:text-sm rounded-t-lg border ${activeTab === "Navbar.jsx"
                                                ? "bg-blue-500/30 text-white border-blue-400/20"
                                                : "bg-white/5 text-gray-300 border-white/10 hover:bg-white/5"} text-gray-300 transition-all duration-200 whitespace-nowrap`}>Navbar.jsx</button>
                                    </div>
                                    {/* Code content */}
                            ...
                            {/* Floating Cards */}
                            <div className={`hidden lg:block absolute bottom-4 right-4 transform translate-x-8 translate-y-8 w-72 
